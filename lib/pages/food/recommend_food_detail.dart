      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            pinned: true,
            backgroundColor: const Color.fromARGB(255, 231, 146, 18),
            expandedHeight: 300,
              ...
              children: [
                GestureDetector(
                  ...
                  child: AppIcon(
                    ...
                    backgroundColor: const Color.fromARGB(255, 41, 238, 199),
                    icon: Icons.remove),
                ),
                  BigText(text: " ${product.price!} \VNĐ X  ${controller.inCartItems} ", color: Color.fromARGB(255, 42, 41, 41),size: Dimensions.font26,),
                GestureDetector(
                  onTap: (){
        ...
        child: Row(
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: BigText(text:" ${product.price!} \VNĐ | Thêm vào giỏ hàng", color: const Color.fromARGB(255, 235, 235, 235),),
